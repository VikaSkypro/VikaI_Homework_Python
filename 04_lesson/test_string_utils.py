...
@pytest.mark.parametrize("str2, result",
                         [
                             ...
                             ("  multiple   spaces",
                              "  Multiple   spaces")  # при Multiple   spaces - ошибка
                          ])
def test_string_capitilize_neg1(str2, result):
    assert string.capitilize(str2) == result
...
def test_string_end_with_neg1(str14, symbol, res):
    assert string.end_with(str14, symbol) == res
